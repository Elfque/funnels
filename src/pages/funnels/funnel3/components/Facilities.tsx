  ...
  return (
    <div>
      <div className="text-center mb-8">
        <div className="text-blue-500 mb-2 text-5xl">Facilities</div>
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 w-5/6 mx-auto text-center">
        <div className="bg-white">
          ...
          <div className="p-2">
            ...
            <div>
              Nausce arcu est, pretium in blandit eu, gravida at nunc. Sed
              efficitur suscipit enim, vel lacinia augue. Sed sodales nisi id
              Nullam pulvinar maximus.
            </div>
          </div>
        </div>
        <div className="bg-white">
